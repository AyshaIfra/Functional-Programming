...
object Q4
{
	def main(args:Array[String])
	{
		...
		var acc1=new account("A123",1001,25000);
		var acc2=new account("A124",1002,10000);
		var acc3=new account("A125",1003,50000);
		var acc4=new account("A126",1004,-1000);
		var acc5=new account("A127",1005,-10000);
		var acc6=new account("A128",1006,0);
	...
	val balance=(list:List[account])=>list.reduce((x,y)=>new account("A000",1000,x.aBalance+y.aBalance));
